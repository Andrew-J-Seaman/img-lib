...
Store image files (`.jpg`, `.png`) to be accessed via address link. 
	Example: "Better Canvas" browser extension allows users to set custom dashboard course card images.
